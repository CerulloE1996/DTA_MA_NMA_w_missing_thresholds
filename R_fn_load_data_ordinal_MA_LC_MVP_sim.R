...
simulate_binary_and_ordinal_MA_LC_MVP_data <- function(   n_studies = 10,
         ...
         n_total_obs_thr_per_test <- c(1, 3, 5, 5, 12)
         ...
         SD_of_thr_for_all_tests_array <- array(0.25, dim = c(n_tests, max_threshold_across_all_tests)) ## between-study heterogenity for thresholds 
