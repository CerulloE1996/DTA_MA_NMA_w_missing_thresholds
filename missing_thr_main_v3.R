...

{
        ...
        
        {
            ...
            print( mean(abs(round(est_Se_OVERALL$mean, 3) - round(true_Se_OVERALL, 3))) )
            message(paste("Se (MEDIAN of abs. diffs) = "))
            print( median(abs(round(est_Se_OVERALL$mean, 3) - round(true_Se_OVERALL, 3))) )
            ...
            print( mean(abs(round(est_Sp_OVERALL$mean, 3) - round(true_Sp_OVERALL, 3))) )
            message(paste("Sp (MEDIAN of abs. diffs) = "))
            print( median(abs(round(est_Sp_OVERALL$mean, 3) - round(true_Sp_OVERALL, 3))) )
            message(paste("Sp (MAX of abs. diffs) = "))
            print( max(abs(round(est_Sp_OVERALL$mean, 3) - round(true_Sp_OVERALL, 3))) )
        }
        
        
        plot(x = 1.0 - est_Sp_OVERALL$mean, y = est_Se_OVERALL$mean, col = "blue")
