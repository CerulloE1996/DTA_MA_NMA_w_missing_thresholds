...
transformed parameters { 
        ...
        // real Jacobian_raw_scale_to_scale = 0.0;
        {
            ...
            //     scales[1, s] = exp(-0.5*(raw_scale_mu + raw_scale_SD * raw_scale_z[s]));
            //     scales[2, s] = exp(+0.5*(raw_scale_mu + raw_scale_SD * raw_scale_z[s]));
            // }
            for (s in 1:n_studies) {
...
generated quantities {
          ...
          ////
          {
            ...
            for (k in 1:n_thr) {
                  ...
                  Sp[k] =   1.0 - Fp[k];
                  Se[k] =   1.0 - Phi((C_MU[k] - location_d)/scale_d);
            }
          }
          ////
          ...
          ////
          {
              ...
              for (k in 1:n_thr) {
                      ...
                      Se_pred[k] =   1.0 - Phi((C_mu_pred[k] - location_d)/scale_d);
              }
          }
          ////
