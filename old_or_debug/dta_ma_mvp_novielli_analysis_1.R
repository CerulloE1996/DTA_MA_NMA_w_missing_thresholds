...
setwd("/media/enzo/4d1d6922-4dc9-48c1-9a28-0ee8f75f356d/enzo/Documents/Work/latent variable modelling/latent trait/Wells")
...
data =  list( n_studies=n,  
              ...
              numg = 5000, 
              ns_cumsum = c(0, cumsum(ns[studies]))[1:n], 
              total_n = sum(ns[studies]),
              ind = c(0, rep(1, n-1)))

init = list(
  mu_pre = t(matrix(data = c(1,  2,
                            -2, -1), ncol = 2))    ,
