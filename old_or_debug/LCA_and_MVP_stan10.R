...
file <- file.path(file = "model_new.stan") 


file <- file.path(file = "mvp_wells_CD_random_cutpoints_logit_scale2.stan") 
...
meta_model2r <-readRDS("Wells_CD_dichot_1st.rds")
